...
(function(window) {
    ...
    message_handlers.opop = function (d) {
        ...
        if(globalConfigData && globalConfigData.oninternalerror && d.data && !d.data.tx && !d.data.success){
            globalConfigData.oninternalerror(1);
        }else if(globalConfigData && globalConfigData.callback)
